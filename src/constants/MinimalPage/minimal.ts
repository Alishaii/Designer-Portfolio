export const title = 'MINIMAL';
export const subtitle = 'Landing Page';

export const smallDescription = 'Website for the presentation and sale \n of products with own production';

export const projectAdditionalInfo = [
